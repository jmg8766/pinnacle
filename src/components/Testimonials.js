  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: `rgba(2,20,132,.85)`, position: `relative`, textAlign: `center`, fontWeight: `bold`, color: `white` }}>
        ...
        <div style={{ position: `absolute`, top: `2.5vw`, width: `100%` }}>
          <FontAwesomeIcon icon={faChevronLeft} size="5x" style={{ position: `absolute`, left: `15px`, top: `50%`, color: `white` }} onClick={this.prev}/>
          <FontAwesomeIcon icon={faChevronRight} size="5x" style={{ position: `absolute`, right: `15px`, top: `50%`, color: `white` }} onClick={this.next}/>
