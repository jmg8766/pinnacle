...
export default ({ data }) =>
  <Layout img={ data.banner.childImageSharp.fluid } title="Portfolio">
    ...
    <div style={{ maxWidth: `1200px`, margin: `auto`}}>
      ...
      <div className="row">
        <div className="column">
          <img src={Crane} alt="Plum Brook’s Space Power Facility" style={{ display: `block`}}/>
...
export const query = graphql`
  query {
    banner: file(relativePath: { eq: "portfoliobanner.jpeg" }) {
      childImageSharp {
        fluid(quality: 100, cropFocus: NORTH) {
