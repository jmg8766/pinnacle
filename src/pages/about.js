...
export default ({ data }) => (
  <div className="page-template page-template-_page-templates page-template-About page-template-_page-templatesAbout-php page page-id-8 masthead-fixed full-width footer-widgets singular">
    <div className="hfeed site">
      <Header/>
        <section className="content-area">
            <Img fluid={data.placeholderImage.childImageSharp.fluid} style={{ backgroundPosition: 'fixed', width: `100%`, maxHeight: `500px`}}/>
